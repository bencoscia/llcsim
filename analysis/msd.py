...
from llcsim.analysis import Poly_fit, top, Atom_props
from llcsim.llclib import physical, topology, timeseries, fitting_functions
...
class Diffusivity(object):
    ...
    def plot_power_law(self, bins=25):
        ...
        # plt.savefig('/home/bcoscia/PycharmProjects/llcsim/Ben_Manuscripts/transport/figures/msd_power_law.pdf')
        # plt.show()
        # exit()
...
if __name__ == "__main__":
    ...
    if args.compare:
        ...
        plt.gcf().get_axes()[0].tick_params(labelsize=14)
        plt.tight_layout()
        #plt.savefig('/home/bcoscia/PycharmProjects/llcsim/Ben_Manuscripts/transport/figures/ethanol_msd_comparison.pdf')
        plt.show(block=True)
