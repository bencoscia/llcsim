...
import argparse
import mdtraj as md
from llcsim.llclib import physical, topology
...
class System(object):
    ...
    def plot(self, resname='Water'):
        ...
        plt.tight_layout()
        #plt.savefig('/home/bcoscia/PycharmProjects/llcsim/Ben_Manuscripts/transport/supporting_figures/5wt_offset_xlinked_equil.pdf')
        plt.show()
